<script lang="ts">
	...
	const teamMembers = [
		{ name: 'Ishan G', role: 'Programming Co-Lead, Outreach Team', image: '/Ishan.jpg', rookieYear: '2023-24 FLL Masterpiece', description: 'Ishan is a 7th grader from Pine Lake Middle School who loves to code, work with others and help them out, whether he is at home or at robotics coding and helping others is his favorite thing to do.'},
		{ name: 'Ishika S', role: 'Outreach Lead, Build Team', image: '/Ishika.png', rookieYear: '2023-24 FLL Masterpiece', description: 'Ishika is a 9th grader from East side Catholic High School who loves building, coding and helping others out her passion for robotics is amazing and is one trait that makes her a great leader'},
